...
public enum WorldEvent {
    ...
    JIANGSHI_LIGHTNING_START("⚡️⚡️ Stalker Jiangshi ⚡️⚡️", "jiangshiLightningStart", "Jiangshi lightning started", ", which channel did the lightning start in?", "jl-", 2),
    ...
    GIGANURA_LIGHTNING_START("⚡️⚡️ Giganura ⚡️⚡️", "giganuraLightningStart", "Giganura lightning started", ", which channel did the lightning start in?", "gl-", 2),
    ...
    TOP_DOG_WU_FU_LIGHTNING_START("⚡️⚡️ Top Dog Wu Fu ⚡️⚡️", "wuFuLightningStart", "Top Dog Wu Fu lightning started", ", which channel did the lightning start in?", "wl-", 2),
    ...
    KING_BULBARI_LIGHTNING_START("⚡️⚡️ King Bulbari ⚡️⚡️", "kingBulbariLightningStart", "King Bulbari lightning started", ", which channel did the lightning start in?", "kbl-", 2),
    ...
    GOLDEN_DEVA_LIGHTNING_START("⚡️⚡️ Golden Deva ⚡️⚡️", "goldenDevaLightningStart", "Golden Deva lightning started", ", which channel did the lightning start in?", "gdl-", 2),
    ...
    PINCHY_LIGHTNING_START("⚡️⚡️ Pinchy ⚡️⚡️", "pinchyLightningStart", "Pinchy lightning started", ", which channel did the lightning start in?", "pl-", 2),
